...
# define the PDE and the boundary conditions
def pde(x, y):
...
# on the field  [-1,1]x[-1,1] and time [0,0.99]
geom = dde.geometry.Interval(-1, 1)
timedomain = dde.geometry.TimeDomain(0, 0.99)
geomtime = dde.geometry.GeometryXTime(geom, timedomain) # two boundary conditions
